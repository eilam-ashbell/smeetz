var tQ = document.getElementById("ticket-quantity"),
  ...
  plan = {
            ...
            astronautY  : 0},
  tFeesCalc, t, a,
  eFees = {monthMonth: 49, monthYear: 39, onlineFee: 0.035, offlineFee: 0.39 },
  pFees = { monthMonth: 129, monthYear: 99, onlineFee: 0.025, offlineFee: 0.19 },
  aFees = { monthMonth: 329, monthYear: 249, onlineFee: 0.015, offlineFee: 0 },
  eFeesUSD = { monthMonth: 53, monthYear: 42, onlineFee: 0.035, offlineFee: 0.53 },
  pFeesUSD = { monthMonth: 139, monthYear: 109, onlineFee: 0.025, offlineFee: 0.2 },
  aFeesUSD = { monthMonth: 359, monthYear: 269, onlineFee: 0.015, offlineFee: 0 },
  eFeesEur = { monthMonth: 46, monthYear: 36, onlineFee: 0.035, offlineFee: 0.45 },
  pFeesEur = { monthMonth: 119, monthYear: 89, onlineFee: 0.025, offlineFee: 0.17 },
  aFeesEur = { monthMonth: 309, monthYear: 229,  onlineFee: 0.015, offlineFee: 0 };
...
function formatCHF(selectPlan) {
    return (new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'CHF', minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(selectPlan));
};

function formatUSD(selectPlan) {
    return (new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(selectPlan));
};

function formatEUR(selectPlan) {
    return (new Intl.NumberFormat('en-EN', { style: 'currency', currency: 'EUR', minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(selectPlan));
};

function formatPrecents(selectPlan) {
    return (new Intl.NumberFormat('en-EN', { style: 'percent', minimumFractionDigits: 1 }).format(selectPlan));
};
