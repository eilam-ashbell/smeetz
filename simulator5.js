...
function calcYearly(planFee) {
    return (((tFeesCalc*planFee.onlineFee*monthAmount.value)+(tQ.value*t*planFee.offlineFee*monthAmount.value)+(planFee.monthYear*12))/12);
};
